...
\section{Motivation}
Data science is an absorbing domain. Transforming raw data into meaningful insights is just magic. And when the data is bio-medical, the task gets more interesting. 
