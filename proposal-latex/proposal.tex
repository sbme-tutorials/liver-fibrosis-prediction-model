...
Violin Plot can be used used to visualize the distribution of the data and its probability density. It can be used to find out which features give better information for classification. 
\subsubsection{Swarm plot} 
Swarm plot is s good complement to a violin plot as it shows all observations along with some representation of the underlying distribution. It can be used for feature selection based on data variance.
