...
discretize(hvc_data,"AST4",c(0,20,40,128),c(1,2,3))
discretize(hvc_data,"AST12",c(0,20,40,128),c(1,2,3))
discretize(hvc_data,"AST24",c(0,20,40,128),c(1,2,3))
discretize(hvc_data,"AST36",c(0,20,40,128),c(1,2,3))
discretize(hvc_data,"AST48",c(0,20,40,128),c(1,2,3))
